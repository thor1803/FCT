...
module.exports = function( grunt ) {
    ...
    config = config();
    config.files.js.push( 'assets/js/*.js', '!assets/js/vendor/**/*.js', '!assets/bootstrap/js/**/*.js', '!grunt/**/*.js', '!inc/customizer/customizer-repeater/**/*.js', '!inc/customizer/customizer-alpha-color-picker/js/alpha-color-picker.js', '!js/navigation.js',
